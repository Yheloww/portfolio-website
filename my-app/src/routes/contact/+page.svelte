...
<div class="wrapper">
    <div class="aboutme">
        <div class="texte">
            <p class="description">Hello my name is Héloïse Feldmann. I am a junior data analyst, and I am currently following a bootcamp at Becode. What I like about data analysis is the ability to create stories. 
                I learned the standard skills for a data analyst, then I found some interest in data viz on the web and interactivity. so I am also developping skills for front-end web development.I am also passionate about creative coding.
            </p>
            <div class="socials">
    ...
    <div class="cards">
        <div class="card" id="progra-card">
            ...
            <ul class=progra-list>
                ...
                <li>
                    <svg width="48px" height="48px" viewBox="-8.78 0 70 70" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:cc="http://creativecommons.org/ns#" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns="http://www.w3.org/2000/svg">
